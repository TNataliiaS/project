...
document.addEventListener('DOMContentLoaded', function () {
  ...
  */
      ...
      loopFix: function loopFix(e) {
        ...
        if (o.allowSlidePrev = c, o.allowSlideNext = p, o.controller && o.controller.control && !n) {
          ...
          Array.isArray(o.controller.control) ? o.controller.control.forEach(function (t) {
            !t.destroyed && t.params.loop && t.loopFix(_objectSpread(_objectSpread({}, _e24), {}, {
              slideTo: t.params.slidesPerView === m.slidesPerView && s
            }));
          }) : o.controller.control instanceof o.constructor && o.controller.control.params.loop && o.controller.control.loopFix(_objectSpread(_objectSpread({}, _e24), {}, {
      ...
      function p(e) {
        ...
        if (t.params.loop) {
          ...
          if (_s27 > t.slides.length - t.loopedSlides) {
            ...
            _a19 === t.activeIndex && t.slideToLoop(_e45, 0, !1, !0);
          }
          t.slideToLoop(a);
        } else t.slideTo(a);
      }
      function u() {
        ...
        p.forEach(function (e, r) {
          if ("fraction" === s.type && (e.querySelectorAll(ee(s.currentClass)).forEach(function (e) {
            ...
            var _n7 = 1,
              _l7 = 1;
            "horizontal" === _i13 ? _n7 = _r10 : _l7 = _r10, e.querySelectorAll(ee(s.progressbarFillClass)).forEach(function (e) {
              ...
              if (r.freeMode.momentum) {
                if (c.velocities.length > 1) {
                  var _e58 = c.velocities.pop(),
                    ...
                    _a25 = _e58.position - _s38.position,
                    _i17 = _e58.time - _s38.time;
                  t.velocity = _a25 / _i17, t.velocity /= 2, Math.abs(t.velocity) < r.freeMode.minimumVelocity && (t.velocity = 0), (_i17 > 150 || l() - _e58.time > 300) && (t.velocity = 0);
                } else t.velocity = 0;
                ...
                if (_f && i("transitionEnd", function () {
                  ...
                  if (_e59 = o ? Math.abs((-_p3 - t.translate) / t.velocity) : Math.abs((_p3 - t.translate) / t.velocity), r.freeMode.sticky) {
                    ...
                    _e59 = _s40 < _a26 ? r.speed : _s40 < 2 * _a26 ? 1.5 * r.speed : 2.5 * r.speed;
                  }
        ...
        updateWrapperSize: function updateWrapperSize(e, s, a) {
          ...
          if (i.virtualSize = (e + o) * t, i.virtualSize = Math.ceil(i.virtualSize / d) - o, i.wrapperEl.style[a("width")] = "".concat(i.virtualSize + o, "px"), r) {
            ...
            for (var _t43 = 0; _t43 < s.length; _t43 += 1) {
              var _a28 = s[_t43];
              l && (_a28 = Math.floor(_a28)), s[_t43] < i.virtualSize + s[0] && _e61.push(_a28);
            }
      ...
      s({
        ...
        setTranslate: function setTranslate() {
          ...
          for (var _s42 = 0; _s42 < e.length; _s42 += 1) {
            ...
            var _a29 = -_e62.swiperSlideOffset;
            ...
            var _r15 = t.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(_e62.progress), 0) : 1 + Math.min(Math.max(_e62.progress, -1), 0),
              _n8 = le(0, _e62);
            _n8.style.opacity = _r15, _n8.style.transform = "translate3d(".concat(_a29, "px, ").concat(_i19, "px, 0px)");
          }
        },
  ...
  function toggleImages() {
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
      ...
      for (var i = 0; i < projectsItem.length; i++) {
        projectsItem[i].onclick = function (image) {
  ...
  var swiperPartners = new Swiper('.company-partners__swiper', {
    loop: true,
    slidesPerView: 3,
    spaceBetween: 20,
    speed: 700,
